...
class TestToolsAutoGenerationIntegration:
    ...
    async def test_get_code_by_id_tool_with_disabled_generation(
        ...
        try:
            ...
            tool = GetCodeByIdTool(db_manager=db_manager, auto_generate_documentation=False)
    ...
    async def test_get_code_by_id_tool_with_enabled_generation_mocked(
        ...
        try:
            ...
            tool = GetCodeByIdTool(db_manager=db_manager, auto_generate_documentation=True)
    ...
    async def test_get_node_workflows_tool_with_disabled_generation(
        ...
        try:
            # Create tool with auto-generation disabled
            tool = GetNodeWorkflowsTool(db_manager=db_manager, company_id="default_user", auto_generate=False)
    ...
    async def test_get_node_workflows_tool_with_enabled_generation_mocked(
        ...
        try:
            # Create tool with auto-generation enabled
            tool = GetNodeWorkflowsTool(db_manager=db_manager, company_id="default_user", auto_generate=True)
    ...
    async def test_both_tools_handle_invalid_node_id(
        ...
        try:
            ...
            code_tool = GetCodeByIdTool(db_manager=db_manager, auto_generate_documentation=True)
            ...
            workflow_tool = GetNodeWorkflowsTool(db_manager=db_manager, company_id="default_user", auto_generate=True)
