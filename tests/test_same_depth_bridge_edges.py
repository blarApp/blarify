...
class TestSameDepthBridgeEdges:
    ...
    def test_mixed_depth_levels(self) -> None:
        ...
        for bridge in bridge_edges:
            ...
            for expected_caller, expected_callee, expected_depth in expected_bridges:
                if (
                    bridge["caller_id"] == expected_caller
                    and bridge["callee_id"] == expected_callee
                    and bridge["depth"] == expected_depth
                ):
                    found = True
                    break
    ...
    def test_maintains_execution_order(self) -> None:
        ...
        edges = [{"caller_id": "main", "callee_id": "b", "depth": 1, "step_order": 0}]
    ...
    def test_complex_real_world_scenario(self) -> None:
        ...
        nodes = [
            {
                "id": "93f77d77e170620b2d73c5caca19c49d",
                "name": "main_diff",
                "path": "file:///Users/berrazuriz/Desktop/Blar/repositories/blarify/blarify/main.py",
                "depth": 0,
            },
            {
                "id": "91824f57fdfdad7eac8228af6e0dfcf8",
                "name": "start",
                "path": "file:///Users/berrazuriz/Desktop/Blar/repositories/blarify/blarify/code_references/lsp_helper.py",
                "depth": 1,
            },
            {
                "id": "d8e6865b17f206f5c5bed946ef020b3e",
                "name": "build",
                "path": "file:///Users/berrazuriz/Desktop/Blar/repositories/blarify/blarify/project_graph_diff_creator.py",
                "depth": 1,
            },
            {
                "id": "5cda78ee6056051fd4bdf378f1adb4a0",
                "name": "_create_code_hierarchy",
                "path": "file:///Users/berrazuriz/Desktop/Blar/repositories/blarify/blarify/project_graph_creator.py",
                "depth": 2,
            },
        ]
