...
class TestNeo4jCredentials:
    ...
    def test_stores_credentials_securely(self, tmp_path, monkeypatch):
    ...
    def test_loads_existing_credentials(self, tmp_path, monkeypatch):
    ...
    def test_creates_new_credentials_when_none_exist(self, tmp_path, monkeypatch):
    ...
    def test_creates_blarify_directory_if_not_exists(self, tmp_path, monkeypatch):
    ...
    def test_credentials_file_is_json_formatted(self, tmp_path, monkeypatch):
