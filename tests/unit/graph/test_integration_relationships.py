...
def test_create_integration_sequence_relationships():
    ...
    relationships = RelationshipCreator.create_integration_sequence_relationships(pr_node, commit_nodes)
    ...
    file_changes = [
        {
            ...
            "deletions": 5,
            "patch": "@@ -45,7 +45,15 @@\n-old\n+new",
            "line_ranges": [{"type": "addition", "start": 45, "end": 60}],
        }
    ]
...
def test_create_affects_relationships():
    ...
    relationships = RelationshipCreator.create_affects_relationships(commit_nodes, [mock_workflow])
