...
@pytest.fixture(scope="session")
async def neo4j_manager() -> AsyncGenerator[Neo4jTestContainerManager, None]:
    """
...
@pytest.fixture
async def neo4j_instance(neo4j_manager: Neo4jTestContainerManager,
                        neo4j_config: Neo4jContainerConfig) -> AsyncGenerator[Neo4jContainerInstance, None]:
    """
...
@pytest.fixture
async def neo4j_instance_with_sample_data(neo4j_instance: Neo4jContainerInstance) -> AsyncGenerator[Neo4jContainerInstance, None]:
    """
...
@pytest.fixture
async def neo4j_instance_empty(neo4j_manager: Neo4jTestContainerManager,
                              neo4j_config: Neo4jContainerConfig) -> AsyncGenerator[Neo4jContainerInstance, None]:
    """
...
def neo4j_query_helper():
    ...
    class Neo4jQueryHelper:
        ...
        @staticmethod
        async def count_relationships(instance: Neo4jContainerInstance, 
                                    rel_type: Optional[str] = None) -> int:
        ...
        @staticmethod
        async def get_node_properties(instance: Neo4jContainerInstance, 
                                    label: str, property_name: str) -> List[Any]:
...
async def neo4j_performance_monitor():
    ...
    class PerformanceMonitor:
        ...
        async def time_query(self, instance: Neo4jContainerInstance, 
                           query: str, parameters: Optional[Dict[str, Any]] = None) -> Tuple[List[Dict[str, Any]], float]:
